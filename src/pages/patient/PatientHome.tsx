    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <Card className="flex items-center justify-between shadow-ambient relative overflow-hidden group">
        ...
        <div className="z-10 flex-1">
          <h2 className="text-xl font-display font-semibold mb-1">Meta semanal</h2>
      ...
      {proxCita && (
        <Card level={2} className="flex items-center gap-4 border-ghost">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-xs font-bold text-on-surface-variant uppercase tracking-wide mb-0.5">Próxima cita</p>
      ...
      <div>
        ...
        {activeRoutines.length > 0 ? (
                ...
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-sm text-on-surface-variant flex items-center gap-1">
                      <PlayCircle size={14} /> {routine.activities.length} Actividades
                    </p>
                  </div>
          ...
          <Card level={2} className="flex flex-col items-center justify-center py-8 text-center border-ghost">
            ...
            <p className="font-display font-semibold text-on-surface mb-1">¡Todo al día!</p>
            <p className="text-sm text-on-surface-variant">Completaste todas tus rutinas asignadas.</p>
          </Card>
        )}
      </div>
    </div>
